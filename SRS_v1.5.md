...
- **ถ้าไม่ตรงกัน:** แสดง warning "มีคนอื่นแก้ไขฟอร์มนี้ขณะที่คุณกำลังแก้ไขอยู่" + แสดง diff การเปลี่ยนแปลง + ให้เลือกว่าจะ:
  - **ทับ (Overwrite):** บันทึกทับการเปลี่ยนแปลงของคนอื่น
  - **รวม (Merge):** รวมการเปลี่ยนแปลง (ถ้าทำได้)
  - **ยกเลิก (Cancel):** ยกเลิกการแก้ไข
...
- **FR-U01** eila_admin สามารถเพิ่ม / ลบ / ลบ / แก้ไข faculty_admin และ executive ได้
...
- Validate file type: JSON เท่านั้น
- Max file size: 5 MB
- Scan for malicious content (ถ้าเป็นไปได้)
